...
public class UserHandler extends AbstractHandler {
	...
	public UserHandler(boolean isBase ) {
		this.isBase = isBase;
	}
...
//	</Response> 
		...
		sb.append("<details_info><info>用户名,昵称,ip,等级,vip等级,体力,精力,元宝,金锭,铜钱,声望,修行,兽魂,最后登录时间,总登录次数,今日登陆次数,总在线时长,角色类型,引导的节点数据,最大关卡位置,斗法玩家仙位等级</info>");
		sb.append("<info>");
		...
		sb.append(  player.getGold() ).append(",");
		...
		sb.append(  user.getLastLoginMillis()).append(",");//最后登录时间，毫秒
		...
		sb.append(  user.getNewPvpManager().getPlayer().getDan());
