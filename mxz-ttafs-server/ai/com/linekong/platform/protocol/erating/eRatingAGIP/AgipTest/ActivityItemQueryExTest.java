...
public class ActivityItemQueryExTest extends debugTest{
	public static void main(String args[]){
		...
		ActivityItemQueryExRequest request=new ActivityItemQueryExRequest();
		...
		long request_commandId = PDUMessage.CMD_ACTIVITY_ITEM_QUERY_EX;
					   ...
					   System.out.println("getResultCode="+respond.getResultCode());					   					   					   		   
				   	   ...
				   	   if( respond.getResultCode()==1)
				   	   {
				   		   ...
				   		   for(int i=0;i<activityCount;i++)
				   		   {
				   			   ...
				   			   {
				   				   System.out.println("itemCode["+i+"]["+k+"]="+itemCode[i][k]);
				   				   System.out.println("itemNum["+i+"]["+k+"]="+itemNum[i][k]);
				   				   System.out.println("bgnTime["+i+"]["+k+"]="+bgnTime[i][k]);
				   				   System.out.println("endTime["+i+"]["+k+"]="+endTime[i][k]);
				   			   }
				   		   }
				   	   }   
				   }
