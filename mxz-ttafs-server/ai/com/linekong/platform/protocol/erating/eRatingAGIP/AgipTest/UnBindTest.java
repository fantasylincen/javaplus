...
import com.linekong.platform.protocol.erating.eRatingAGIP.UnBindRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UnBindRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UnBindTest extends debugTest {
	public static void main(String args[]){
		...
		debugSet(request.setGatewayId(100),"setGatewayId");
		
		long request_commandId = PDUMessage.CMD_UNBIND;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****UnBindRespond result******");
				   UnBindRespond respond= new UnBindRespond();
