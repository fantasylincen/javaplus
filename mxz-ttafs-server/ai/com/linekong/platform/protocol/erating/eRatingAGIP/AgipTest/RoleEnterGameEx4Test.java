...
public class RoleEnterGameEx4Test extends debugTest {
	public static void main(String args[]){
		...
		RoleEnterGameEx4Request request=new RoleEnterGameEx4Request();
		...
		long request_commandId = 0x10003115L;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   RoleEnterGameEx4Respond respond= new RoleEnterGameEx4Respond();
