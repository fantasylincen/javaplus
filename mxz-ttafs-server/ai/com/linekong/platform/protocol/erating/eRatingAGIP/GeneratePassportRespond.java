...
public class GeneratePassportRespond extends eRatingProtocol {
	private final int bodyLength=32+32+4;
	
	private String userName="test001";
	private String pwd="001122";
	...
	public  int analyzeBody(byte[] GeneratePassportResBody)
	{	
		if(GeneratePassportResBody.length!=bodyLength)
			return -1;
		
		byte[] body = GeneratePassportResBody;
