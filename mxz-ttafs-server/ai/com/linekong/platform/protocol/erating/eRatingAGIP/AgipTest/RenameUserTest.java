...
import com.linekong.platform.protocol.erating.eRatingAGIP.RenameUserRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.RenameUserRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class RenameUserTest extends debugTest {
	public static void main(String args[]){
		...
		debugSet(request.setUserName("test001"),"setUserName");
	
		long request_commandId = PDUMessage.CMD_RENAME_USER;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   RenameUserRespond respond= new RenameUserRespond();
