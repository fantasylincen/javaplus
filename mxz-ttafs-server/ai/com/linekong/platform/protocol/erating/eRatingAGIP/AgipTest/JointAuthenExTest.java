...
public class JointAuthenExTest extends debugTest {
	public static void main(String args[]){
		...
		JointAuthenExRequest request=new JointAuthenExRequest();
		debugSet( request.setParamNameAndValue("key","LK"),"setParamNameAndValue");
		long request_commandId = PDUMessage.CMD_JOINT_AUTHEN_EX;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****JointAuthenExRespond result******");
				   JointAuthenExRespond respond= new JointAuthenExRespond();
				   ...
				   else
				   {
					   ...
					   if( respond.getResultCode()==1)
					   {
						   ...
						   System.out.println("getUserClass="+respond.getUserClase());
						   System.out.println("getUserPoint="+respond.getUserPoint());
						   System.out.println("getUserFlag="+respond.getUserFlag()); 
						   
						   System.out.println("getCpReturnValue="+respond.getCpReturnValue());
						   System.out.println("getCpErrMsg="+respond.getCpErrMsg());
						   System.out.println("getUserName="+respond.getUserName());
						   System.out.println("getAppendix1="+respond.getAppendix1());
						   System.out.println("getAppendix2="+respond.getAppendix2()); 
					   }  
				   }
