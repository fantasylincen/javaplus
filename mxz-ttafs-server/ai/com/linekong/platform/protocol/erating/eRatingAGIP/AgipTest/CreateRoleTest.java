...
public class CreateRoleTest extends debugTest {
	public static void main(String args[]){
		...
		long request_commandId = PDUMessage.CMD_CREATE_ROLE;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****CreateRoleRespond result******");
				   CreateRoleRespond respond= new CreateRoleRespond();
				   ...
				   else
				   {
					   ...
					   {
						   System.out.println("getRoleId="+respond.getRoleId());
					   } 
				   }
