...
import com.linekong.platform.protocol.erating.eRatingAGIP.UserAuthEx4Request;
import com.linekong.platform.protocol.erating.eRatingAGIP.UserAuthEx4Respond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UserAuthEx4Test extends debugTest {
	public static void main(String args[]){
		...
		UserAuthEx4Request request=new UserAuthEx4Request();
		...
		long request_commandId = 0x10003313L;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   UserAuthEx4Respond respond= new UserAuthEx4Respond();
