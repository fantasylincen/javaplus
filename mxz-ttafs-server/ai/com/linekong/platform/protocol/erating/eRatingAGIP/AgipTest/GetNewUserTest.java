...
import com.linekong.platform.protocol.erating.eRatingAGIP.GetNewUserRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.GetNewUserRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class GetNewUserTest extends debugTest {
	public static void main(String args[]){
		...
		GetNewUserRequest request=new GetNewUserRequest();
		
		debugSet(request.setUserIP(127L*256L*256L*256L+1L),"setUserIP");
		
		long request_commandId = PDUMessage.CMD_GET_NEW_USER_ID;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****GetNewUserRespond result******");
				   GetNewUserRespond respond= new GetNewUserRespond();
				   ...
				   else
				   {
					   ...
					   {					   		   
					   	   System.out.println("userName="+respond.getUserName());
