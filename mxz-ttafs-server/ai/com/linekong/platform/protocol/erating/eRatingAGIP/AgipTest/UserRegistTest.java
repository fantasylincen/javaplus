...
import com.linekong.platform.protocol.erating.eRatingAGIP.UserRegistRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UserRegistRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UserRegistTest extends debugTest {
	public static void main(String args[]){
		...
		long request_commandId = PDUMessage.CMD_USER_REGIST;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   UserRegistRespond respond= new UserRegistRespond();
