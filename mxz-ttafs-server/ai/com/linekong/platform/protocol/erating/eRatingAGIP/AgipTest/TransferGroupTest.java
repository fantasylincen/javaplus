...
import com.linekong.platform.protocol.erating.eRatingAGIP.TransferGroupRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.TransferGroupRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;
public class TransferGroupTest extends debugTest {
	public static void main(String args[]){
		...
		debugSet(request.setGroupID(123),"setGroupID");
		debugSet(request.setFromRoleID(321),"setFromRoleID");
		debugSet(request.setToRoleID(567),"setToRoleID");
		
		long request_commandId = PDUMessage.CMD_TRANSFER_GROUP;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****TransferGroupRespond result******");
				   TransferGroupRespond respond= new TransferGroupRespond();
