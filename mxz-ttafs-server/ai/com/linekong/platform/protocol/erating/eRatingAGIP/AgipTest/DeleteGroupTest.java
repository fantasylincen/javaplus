...
import com.linekong.platform.protocol.erating.eRatingAGIP.DeleteGroupRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.DeleteGroupRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class DeleteGroupTest extends debugTest{
	public static void main(String args[]){
		...
		debugSet(request.setGroupID(12),"setGroupID");
		debugSet(request.setRoleID(123456),"setRoleID");

		long request_commandId = PDUMessage.CMD_DELETE_GROUP;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****DeleteGroupRespond result******");
				   DeleteGroupRespond respond= new DeleteGroupRespond();
