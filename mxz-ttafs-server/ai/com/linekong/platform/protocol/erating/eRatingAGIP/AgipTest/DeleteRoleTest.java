...
public class DeleteRoleTest extends debugTest {
	public static void main(String args[]){
		...
		long request_commandId = PDUMessage.CMD_DELETE_ROLE;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****DeleteRoleRespond result******");
				   DeleteRoleRespond respond= new DeleteRoleRespond();
