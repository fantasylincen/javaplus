...
import com.linekong.platform.protocol.erating.eRatingAGIP.UnionCpDataPushRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UnionCpDataPushRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UnionCpDataPushTest extends debugTest {
	public static void main(String args[]){
		...
		UnionCpDataPushRequest request=new UnionCpDataPushRequest();
		
		
		debugSet(request.setUnionUserID("123456"),"setUnionUserID");
		debugSet(request.setUnionUserName("test001"),"setUnionUserName");
		debugSet(request.setClientIP(127l*256l*256l*256l+1l),"setClientIP");
		debugSet(request.setCpID("123456"),"setCpID");
		
		
		long request_commandId = 0x10003312L;//CMD_UNION_CP_DATA_PUSH
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   UnionCpDataPushRespond respond= new UnionCpDataPushRespond();
