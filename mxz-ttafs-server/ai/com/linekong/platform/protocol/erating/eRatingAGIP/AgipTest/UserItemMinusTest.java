...
import com.linekong.platform.protocol.erating.eRatingAGIP.UserItemMinusRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UserItemMinusRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UserItemMinusTest extends debugTest {
	public static void main(String args[]){
		...
		UserItemMinusRequest request=new UserItemMinusRequest();
		
		long request_commandId = PDUMessage.CMD_USER_ITEM_MINUS;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   UserItemMinusRespond respond= new UserItemMinusRespond();
