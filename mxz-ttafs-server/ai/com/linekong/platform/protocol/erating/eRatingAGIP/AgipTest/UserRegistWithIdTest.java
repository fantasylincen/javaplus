...
import com.linekong.platform.protocol.erating.eRatingAGIP.UserRegistWithIdRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UserRegistWithIdRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UserRegistWithIdTest extends debugTest {
	public static void main(String args[]){
		...
		UserRegistWithIdRequest request=new UserRegistWithIdRequest();
		
		long request_commandId = PDUMessage.CMD_USER_REGIST_WITH_ID;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   UserRegistWithIdRespond respond= new UserRegistWithIdRespond();
