...
import com.linekong.platform.protocol.erating.eRatingAGIP.UserIbPayRequest;
import com.linekong.platform.protocol.erating.eRatingAGIP.UserIbPayRespond;
import com.linekong.platform.protocol.erating.eRatingAGIP.eRatingProtocol;

public class UserIbPayTest extends debugTest {
	public static void main(String args[]){
		...
		UserIbPayRequest request=new UserIbPayRequest();
		...
		debugSet(request.setPayTime(128250000),"setPayTime");
		debugSet(request.setUserIP(100),"setUserIP");
		 
		 request.setSubjectId((short)1) ;
		 request.setAuditFlag((short)1) ;
		 request.setPrice(100) ;
		 request.setDiscountPrice(98);
		 
		long request_commandId = PDUMessage.CMD_USER_IB_PAY_REQ;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****UserIbPayRespond result******");
				   UserIbPayRespond respond= new UserIbPayRespond();
				   ...
				   else
				   {
					   System.out.println("getResultCode="+respond.getResultCode());
					   	   ...
					   	   //System.out.println("getGroupId="+respond.getGroupId());
					   	   //System.out.println("getPwd="+respond.getPwd());
