...
public class RoleEnterGameEx3Respond extends eRatingProtocol {
	...
	public  int analyzeBody(byte[] RoleEnterGameEx3ResBody)
	{	
		if( (RoleEnterGameEx3ResBody.length-(4+4))%(4+4) !=0 )
			return -1;
		
		byte[] body = RoleEnterGameEx3ResBody;
