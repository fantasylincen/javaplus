...
public class UserBalanceInfoExTest extends debugTest {
	public static void main(String args[]){
		...
		UserBalanceInfoExRequest request=new UserBalanceInfoExRequest();
		
		debugSet(request.setUserId(12),"setUserId");
		debugSet(request.setRoleId(123456),"setRoleId");
		debugSet(request.setRatingId(124),"setRatingId");
		request.setSubjectId(3);
		long request_commandId = PDUMessage.CMD_USER_BALANCE_INFO_EX;
		...
		try{
		   ...
		   for(int j=0;j<2;++j)
		   {
			   ...
			   else
			   {
				   ...
				   System.out.println("\n*****UserBalanceInfoExRespond result******");
				   UserBalanceInfoExRespond respond= new UserBalanceInfoExRespond();
				   ...
				   else
				   {
					   ...
					   System.out.println("getTotalCharge="+respond.getTotalCharge());
					   System.out.println("getLeftAmount="+respond.getLeftAmount());
				   }
