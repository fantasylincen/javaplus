...
public class RoleEnterGameEx4Request extends eRatingProtocol {
	private final int bodyLength=4+4+4+2+1+1+4+2+2+4+4+256+32+32+64;
	...
	public  int analyzeBody(byte[] RoleEnterGameEx4ReqBody)
	{	
		if(RoleEnterGameEx4ReqBody.length!=bodyLength)
			return -1;
		
		byte[] body = RoleEnterGameEx4ReqBody;
		...
		clientMac		=	getStringByLength(b,256);
