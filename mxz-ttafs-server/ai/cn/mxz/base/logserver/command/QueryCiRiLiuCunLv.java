 ...
 *
 */
@Component("telnetCommand:queryciriliucunlv")

public class QueryCiRiLiuCunLv implements TelnetCommand {
	...
	public void run(PrintWriter out, String... args) throws Throwable {
		...
		out.println("次日登陆数:" + countLogind);

		out.println("次日留存率:" + (allCreate.isEmpty() ? 0 : (countLogind + 0f) / allCreate.size()));
	}
}
