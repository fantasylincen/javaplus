 ...
 *
 */
@Component("telnetCommand:querylogintoday")

public class QueryLoginToday implements TelnetCommand {
	...
	public void run(PrintWriter out, String... args) throws Throwable {
		...
		Set<String> allUser = new LoginUsersFinder().findUsers(start, end);

		out.println("");
		out.println("--------" + dateStart + "至" + dateEnd + " 登陆过的玩家列表如下---------");
