 ...
 *
 */
@Component("telnetCommand:querysanriliucunlv")

public class QuerySanRiLiuCunLv implements TelnetCommand {
	...
	public void run(PrintWriter out, String... args) throws Throwable {
		...
		out.println("后3日登陆数:" + countLogind);

		out.println("3日留存率:" + (allCreate.isEmpty() ? 0 : (countLogind + 0f) / allCreate.size()));
	}
}
