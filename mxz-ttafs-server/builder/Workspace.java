...
public class Workspace {
	...
	private static void commit(String string) {
		// 初始化版本库
		setupLibrary();
		...
		.createDefaultAuthenticationManager("lc", "123456");

		DefaultSVNOptions options = SVNWCUtil.createDefaultOptions(true);
		SVNClientManager clientManager = SVNClientManager.newInstance(options,
				authManager);

		System.out.println("正在提交至SVN.... " + string);
		commit(clientManager, new File(string), false, "By 一键打包");
		System.out.println("提交成功:" + string);
	}
	...
	public static void svnUpdate(String string) {
		// 初始化版本库
		setupLibrary();
		...
		update(clientManager, new File(string), SVNRevision.HEAD, SVNDepth.INFINITY);
		System.out.println("svn update over:" + string);
	}
