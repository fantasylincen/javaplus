...
@EventDescrip(desc = "充值(同步)")
public class RechargeEvent_tb extends EventBase{
...
//			UtilBase.encodeString( response, Sdk_tb.getConvertOrderSerial( orderId, user.getUID() ) );
...
//			orderId			= Sdk_tb.getOrderSerialToStr(orderid);
