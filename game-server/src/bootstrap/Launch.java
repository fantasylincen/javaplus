...
public class Launch {
	...
	public static void main(String[] args) throws Exception {
		...
		// 开启 充值回传 服务器
		if (SystemCfg.PLATFORM.equals("91") || SystemCfg.PLATFORM.equals("TB") || SystemCfg.PLATFORM.equals("LB")) {
		...
		// "Host 'WIN-C1TUHUI3N7B' is not allowed to connect to this MySQL server"
