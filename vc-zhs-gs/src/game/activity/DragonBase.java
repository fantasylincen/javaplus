...
//	private List<ParticipationBase> theTopTens				= new ArrayList<ParticipationBase>();
	...
	public int get_hpBase() {
		return _hpBase;
	}


	public void set_hpBase(int _hpBase) {
		this._hpBase = _hpBase;
	}


	public int get_hpCur() {
		return _hpCur;
	}


	public void set_hpCur(int _hpCur) {
		this._hpCur = _hpCur;
	}


	public int get_attackBase() {
		return _attackBase;
	}


	public void set_attackBase(int _attackBase) {
		this._attackBase = _attackBase;
	}
	...
	public List<ParticipationBase> get_participations() {
		return _participations;
	}


	public void set_participations(List<ParticipationBase> _participations) {
	...
	public static Comparator<ParticipationBase> getComparator() {
		return comparator;
	}
