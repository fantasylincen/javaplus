...
import game.events.all.recharge.RechargeEvent_dz;
...
public enum Event {
	...
	RECHARGE_EVENT_PP					( 507, 		new RechargeEvent_pp() ),			// 充值系统-PP助手
	RECHARGE_EVENT_DZ					( 508, 		new RechargeEvent_dz() ),			// 充值系统-定制助手
