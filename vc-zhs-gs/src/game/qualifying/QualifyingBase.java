...
public class QualifyingBase {
	...
	public byte getResidueDegree() {
		return residueDegree;
	}

	public void setResidueDegree(byte residueDegree) {
	...
	public List<BattlefieldReport> getBattlefields() {
		return battlefields;
	}

	public void setBattlefields(List<BattlefieldReport> battlefields) {
