package cn.mxz.server.system;

import java.util.HashMap;
import java.util.Map;

import cn.mxz.server.mongo.MongoGen;
import cn.mxz.server.mongo.MongoGen.Daos;
import cn.mxz.server.mongo.MongoGen.SystemCounterDao;
import cn.mxz.server.mongo.MongoGen.SystemCounterDao.SystemCounterDtoCursor;
import cn.mxz.server.mongo.MongoGen.SystemCounterDto;
