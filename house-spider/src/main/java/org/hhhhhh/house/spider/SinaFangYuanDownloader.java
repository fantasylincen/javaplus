...
public class SinaFangYuanDownloader implements FangYuanWangDownloader {

	String url = "http://bj.esf.sina.com.cn/detail/146221297/";
	...
	public List<HouseDto> download() {
		...
		String content1 = WebContentFethcer.get("utf8", url);
	...
	private HouseDto getHouseData(String url) {
		...
		String houseInfo = WebContentFethcer.get("utf8", url);
		// try {
		...
		String name = yun_right.getElementsByAttributeValue("class", "hua_ya")
				.get(0).text().trim();
		...
		dto.setHref(url);
		Element dd = yun_right.getElementsByAttributeValue("class",
				"yi_jia_left").get(0);
		Elements dls = dd.getElementsByTag("p");

		Elements lou_ming = ee.getElementsByTag("lou_ming");

		String tel = yun_right.getElementsByAttributeValue("class", "hao_ma")
				.get(0).text();
		String who = yun_right
				.getElementsByAttributeValue("style",
						" color:#42c1ee; font-weight:bold; font-size:15px;")
				.get(0).text();
	...
	public static void main(String[] args) {
		SinaFangYuanDownloader d = new SinaFangYuanDownloader();
