...
//	private final Color VELOCITY_COLOR = new Color(1.0f, 0, 0f, 1f);
	...
	private final Color SHAPE_NOT_ACTIVE = Color.RED;
	private final Color SHAPE_STATIC = Color.RED;
	private final Color SHAPE_KINEMATIC = Color.RED;
	private final Color SHAPE_NOT_AWAKE = Color.RED;
	private final Color SHAPE_AWAKE = Color.RED;
	private final Color JOINT_COLOR = Color.RED;
	private final Color AABB_COLOR = Color.RED;
	private final Color VELOCITY_COLOR = Color.BLUE;
	...
	protected void renderBody (IBody body) {
	...
	private Color getColorByBody (IBody body) { 
	...
	private void drawJoint (Joint joint) {
		IBody bodyA = joint.getBodyA();
		IBody bodyB = joint.getBodyB();
