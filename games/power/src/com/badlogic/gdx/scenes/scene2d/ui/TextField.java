...
public class TextField extends Widget implements Disableable {
	...
	private TextField findNextTextField (Array<IActor> actors, TextField best, Vector2 bestCoords, Vector2 currentCoords, boolean up) {
		for (int i = 0, n = actors.size; i < n; i++) {
			...
			if (actor instanceof TextField) {
				...
				best = findNextTextField(((IGroup)actor).getChildren(), best, bestCoords, currentCoords, up);
		}
		return best;
	}
