...
public class ClickListener extends InputListener {
	...
	public void enter (InputEvent event, float x, float y, int pointer, IActor fromActor) {
		if (pointer == -1 && !cancelled) over = true;
	}

	public void exit (InputEvent event, float x, float y, int pointer, IActor toActor) {
	...
	public boolean isOver (IActor actor, float x, float y) {
		IActor hit = actor.hit(x, y, true);
