...
public class Actions {
	...
	static public AddAction addAction (Action action, IActor targetActor) {
		AddAction addAction = action(AddAction.class);
	...
	static public RemoveAction removeAction (Action action, IActor targetActor) {
		RemoveAction removeAction = action(RemoveAction.class);
	...
	static public RemoveActorAction removeActor (IActor removeActor) {
	...
	static public AddListenerAction addListener (EventListener listener, boolean capture, IActor targetActor) {
		AddListenerAction addAction = action(AddListenerAction.class);
		addAction.setTargetActor(targetActor);
		addAction.setListener(listener);
		addAction.setCapture(capture);
	...
	static public RemoveListenerAction removeListener (EventListener listener, boolean capture, IActor targetActor) {
		RemoveListenerAction addAction = action(RemoveListenerAction.class);
		addAction.setTargetActor(targetActor);
		addAction.setListener(listener);
		addAction.setCapture(capture);
