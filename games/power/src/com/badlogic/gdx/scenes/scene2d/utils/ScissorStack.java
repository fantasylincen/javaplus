...
public class ScissorStack {
	...
	public static IRectangle popScissors () {
		IRectangle old = scissors.pop();
		if (scissors.size == 0)
	...
	public static void calculateScissors (ICamera camera, float viewportX, float viewportY, float viewportWidth,
	...
	public static IRectangle getViewport () {
		if (scissors.size == 0) {
	...
	public static void toWindowCoordinates (ICamera camera, Matrix4 transformMatrix, Vector2 point) {
