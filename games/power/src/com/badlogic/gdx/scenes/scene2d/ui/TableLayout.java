 ...
 * @author Nathan Sweet */
class TableLayout extends BaseTableLayout<IActor, Table, TableLayout, TableToolkit> {
	...
	public void layout () {
		...
		if (round) {
			for (int i = 0, n = cells.size(); i < n; i++) {
				...
				IActor actor = (IActor)c.getWidget();
		...
		Array<IActor> children = table.getChildren();
