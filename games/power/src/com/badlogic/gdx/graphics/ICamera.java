...
public interface ICamera {
	...
	public abstract void normalizeUp();
	...
	public abstract void rotate(float angle, float axisX, float axisY,
			float axisZ);
	...
	public abstract void rotate(Matrix4 transform);
	 ...
	 * @param axis
	 * @param angle the angle */
	public abstract void rotateAround(Vector3 point, Vector3 axis, float angle);
	...
	public abstract void translate(Vector3 vec);
	...
	public abstract void unproject(Vector3 vec, float viewportX,
	...
	public abstract void unproject(Vector3 vec);
	...
	public abstract void project(Vector3 vec);
	 ...
	 * @param viewportWidth the width of the viewport in pixels
	 * @param viewportHeight the height of the viewport in pixels */
	public abstract void project(Vector3 vec, float viewportX, float viewportY,
	...
	public abstract Ray getPickRay(float x, float y, float viewportX,
			float viewportY, float viewportWidth, float viewportHeight);
	 ...
	 * @param y the y-coordinate in window coordinates.
	 * @return the picking Ray. */
	public abstract Ray getPickRay(float x, float y);

	public abstract float getViewPortHeight();

	public abstract Matrix4 getCombined();

	public abstract void setViewportHeight(float height);

	public abstract void setViewportWidth(float width);

	public abstract void setPosition(float centerX, float centerY, int z);
