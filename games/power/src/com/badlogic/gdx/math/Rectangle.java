...
public class Rectangle implements Serializable, IRectangle {
	...
	/** Static temporary rectangle. Use with care! Use only when sure other code will not also use this. */
	static public final IRectangle tmp2 = new Rectangle();
	...
	public IRectangle set (float x, float y, float width, float height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	/* ���� Javadoc��
	 * @see com.badlogic.gdx.math.IRectangle#getX()
	 */
	@Override
	public float getX () {
		return x;
	 ...
	 * @return this rectangle for chaining */
	public IRectangle setX (float x) {
		this.x = x;
	...
	/* ���� Javadoc��
	 * @see com.badlogic.gdx.math.IRectangle#getY()
	 */
	@Override
	public float getY () {
		return y;
	 ...
	 * @return this rectangle for chaining */
	public IRectangle setY (float y) {
		this.y = y;
	...
	/* ���� Javadoc��
	 * @see com.badlogic.gdx.math.IRectangle#getWidth()
	 */
	@Override
	 ...
	 * @param width The width 
	 * @return this rectangle for chaining */
	public IRectangle setWidth (float width) {
		this.width = width;
	...
	/* ���� Javadoc��
	 * @see com.badlogic.gdx.math.IRectangle#getHeight()
	 */
	@Override
	 ...
	 * @param height The height 
	 * @return this rectangle for chaining */
	public IRectangle setHeight (float height) {
		this.height = height;
	 ...
	 * @return this rectangle for chaining */
	public IRectangle setPosition (Vector2 position) {
	 ...
	 * @param y The y-coordinate 
	 * @return this rectangle for chaining */
	public IRectangle setPosition (float x, float y) {
		this.x = x;
		this.y = y;
	 ...
	 * @param height The height 
	 * @return this rectangle for chaining */
	public IRectangle setSize (float width, float height) {
		this.width = width;
		this.height = height;
	 ...
	 * @return this rectangle for chaining */
	public IRectangle setSize (float sizeXY) {
		this.width = sizeXY;
		this.height = sizeXY;
	 ...
	 * @return this rectangle for chaining */
	public IRectangle set (Rectangle rect) {
		this.x = rect.x;
		this.y = rect.y;
	 ...
	 * @param rect the other rectangle
	 * @return this rectangle for chaining */
	public IRectangle merge (Rectangle rect) {
	...
	public IRectangle setCenter (float x, float y) {
	 ...
	 * @return this for chaining */
	public IRectangle setCenter (Vector2 position) {
	 ...
	 * @return this rectangle for chaining */
	public IRectangle fitOutside (Rectangle rect) {
	 ...
	 * @return this rectangle for chaining */
	public IRectangle fitInside (Rectangle rect) {
		float ratio = getAspectRatio();
