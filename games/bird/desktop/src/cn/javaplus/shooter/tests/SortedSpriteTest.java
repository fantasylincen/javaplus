...
public class SortedSpriteTest extends GdxTest {
	/**
	 * Sprite based class that adds a z-coordinate for depth sorting. Note that
	 * allt he constructors were auto-generated in Eclipse (alt + shift + s, c).
	 * 
	 * @author mzechner
	 */
	...
	/**
	 * Comparator used for sorting, sorts in ascending order (biggset z to
	 * smallest z).
	 * 
	 * @author mzechner
	 */
	...
	public void create() {
		...
		for (int i = 0; i < 100; i++) {
			...
			sprite.setPosition(MathUtils.random() * Gdx.graphics.getWidth(),
