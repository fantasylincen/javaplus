...
public class MultitouchTest extends GdxTest {
	...
	Color[] colors = { Color.RED, Color.BLUE, Color.GREEN, Color.WHITE,
			Color.PINK, Color.ORANGE, Color.YELLOW, Color.MAGENTA, Color.CYAN,
	...
	public void render() {
		...
		for (int i = 0; i < 10; i++) {
			...
			renderer.triangle(x, y + size, x + size, y - size, x - size, y
					- size);
		}
		renderer.end();
	}
	...
	public void create() {
		...
		camera.position.set(Gdx.graphics.getWidth() / 2.0f,
