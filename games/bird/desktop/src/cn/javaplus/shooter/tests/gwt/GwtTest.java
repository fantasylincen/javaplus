...
package cn.javaplus.shooter.tests.gwt;
...
public class GwtTest extends GdxTest {
	...
	public void create() {
		...
		mesh = new Mesh(VertexDataType.VertexBufferObject, true, 6, 0,
				VertexAttribute.Position(), VertexAttribute.TexCoords(0));
		mesh.setVertices(new float[] { -0.5f, -0.5f, 0, 0, 1, 0.5f, -0.5f, 0,
				1, 1, 0.5f, 0.5f, 0, 1, 0, 0.5f, 0.5f, 0, 1, 0, -0.5f, 0.5f, 0,
				0, 0, -0.5f, -0.5f, 0, 0, 1 });

		texture = new Texture(new Pixmap(
				Gdx.files.internal("data/badlogic.jpg")), true);
		texture.setFilter(TextureFilter.MipMap, TextureFilter.Linear);

		String params = Gdx.files.internal("data/gwttestparams.txt")
				.readString();
		...
		for (int i = 0; i < numSprites; i++) {
			positions.add(new Vector2(MathUtils.random()
	...
	public void render() {
		...
		font.draw(batch, "fps:" + Gdx.graphics.getFramesPerSecond()
				+ ", delta: " + Gdx.graphics.getDeltaTime() + ", #sprites: "
				+ numSprites, 0, 30);
