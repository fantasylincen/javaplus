...
public class BitmapFontFlipTest extends GdxTest {
	...
	private BitmapFontCache cacheScaled1, cacheScaled2, cacheScaled3,
			cacheScaled4, cacheScaled5;
	int renderMode;
	...
	public void create() {
		...
		spriteBatch.setProjectionMatrix(new Matrix4().setToOrtho(0,
		...
		font = new BitmapFont(Gdx.files.internal("data/verdana39.fnt"),
				Gdx.files.internal("data/verdana39.png"), true);
		...
		createCaches("cache scaled", cacheScaled1, cacheScaled2, cacheScaled3,
				cacheScaled4, cacheScaled5);
	}

	private void createCaches(String type, BitmapFontCache cache1,
			BitmapFontCache cache2, BitmapFontCache cache3,
		...
		cache3.setMultiLineText(text, 5, 320 - 200, 470,
	...
	private void renderNormal(String type) {
		...
		font.setColor(red);
		font.drawWrapped(spriteBatch, text, 0, 320 - 300, 480,
				HAlignment.CENTER);
		...
		font.drawMultiLine(spriteBatch, text, 5, 320 - 200, 470,
