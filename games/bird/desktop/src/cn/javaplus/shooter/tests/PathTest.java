...
public class PathTest extends GdxTest {
	...
	public void create() {
		...
		obj = new Sprite(new Texture(
				Gdx.files.internal("data/badlogicsmall.jpg")));
		obj.setSize(40, 40);
		obj.setOriginCenter();
		obj2 = new Sprite(new Texture(
				Gdx.files.internal("data/bobrgb888-32x32.png")));
		obj2.setSize(40, 40);
		...
		paths.add(new Bezier<Vector2>(new Vector2(0, 0), new Vector2(0, h),
				new Vector2(w, h)));
		paths.add(new Bezier<Vector2>(new Vector2(0, 0), new Vector2(w, 0),
