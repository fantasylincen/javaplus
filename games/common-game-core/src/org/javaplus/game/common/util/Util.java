...
public class Util {
	...
	public static final class Properties {
		...
		public static final java.util.Properties getProperties(String result) {
	...
	public static final class Xml {
		...
		public static Element getData(Element ne) {
			Element e = ne.getChildByName("Data");
			if (e != null)
				return e;

			return ne.getChildByName("ss:Data");
		}
	}
	...
	public static final class Str {
		...
		public static String removeSame(String... ss) {
			...
			set.remove("");
			return Util.Collection.linkWith(Lists.newArrayList(set), "");
		}
	...
	public static final class Collection {
		...
		public static <T> T getLast(List<T> boxes) {
			if (boxes.isEmpty())
				return null;
	...
	public static final class Random {
		...
		public static float get(float min, float max) {
			return Util.R.nextFloat() * (max - min) + min;
		}
	...
	public static class Math {
		...
		public static void main(String[] args) {
			for (double i = 1; i < Double.MAX_VALUE / 9; i*=2) {
				System.out.println(i + "  " + getFormatText(i));
			}
		}
		 ...
		 * @return
		 */
		public static String getFormatText(double v) {
			if (v < 1e5)	return format(v, "");
			if (v < 1e8)	return format(v / 1e3, "K");
			if (v < 1e11)	return format(v / 1e6, "M");
			if (v < 1e14)	return format(v / 1e9, "G");
			if (v < 1e17)	return format(v / 1e12, "T");
			if (v < 1e20)	return format(v / 1e15, "P");
			if (v < 1e23)	return format(v / 1e18, "E");
			if (v < 1e26)	return format(v / 1e21, "Z");
			if (v < 1e29)	return format(v / 1e24, "Y");
			if (v < 1e32)	return format(v / 1e27, "KY");
			if (v < 1e35)	return format(v / 1e30, "MY");
			if (v < 1e38)	return format(v / 1e33, "GY");
			if (v < 1e41)	return format(v / 1e36, "TY");
			if (v < 1e44)	return format(v / 1e39, "PY");
			if (v < 1e47)	return format(v / 1e42, "EY");
			if (v < 1e50)	return format(v / 1e45, "ZY");
			if (v < 1e53)	return format(v / 1e48, "YY");
			if (v < 1e56)	return format(v / 1e51, "KYY");
			if (v < 1e59)	return format(v / 1e54, "MYY");
			if (v < 1e62)	return format(v / 1e57, "GYY");
			if (v < 1e65)	return format(v / 1e60, "TYY");
			if (v < 1e68)	return format(v / 1e63, "PYY");
			if (v < 1e71)	return format(v / 1e66, "EYY");
			if (v < 1e74)	return format(v / 1e69, "ZYY");
			if (v < 1e77)	return format(v / 1e72, "YYY");
			if (v < 1e80)	return format(v / 1e75, "e75");
			if (v < 1e83)	return format(v / 1e78, "e78");
			if (v < 1e86)	return format(v / 1e81, "e81");
			if (v < 1e89)	return format(v / 1e84, "e84");
			if (v < 1e92)	return format(v / 1e87, "e87");
			if (v < 1e95)	return format(v / 1e90, "e90");
			if (v < 1e98)	return format(v / 1e93, "e93");
			if (v < 1e101)	return format(v / 1e96, "e96");
			if (v < 1e104)	return format(v / 1e99, "e99");
			if (v < 1e107)	return format(v / 1e102, "e102");
			if (v < 1e110)	return format(v / 1e105, "e105");
			if (v < 1e113)	return format(v / 1e108, "e108");
			if (v < 1e116)	return format(v / 1e111, "e111");
			if (v < 1e119)	return format(v / 1e114, "e114");
			if (v < 1e122)	return format(v / 1e117, "e117");
			if (v < 1e125)	return format(v / 1e120, "e120");
			if (v < 1e128)	return format(v / 1e123, "e123");
			if (v < 1e131)	return format(v / 1e126, "e126");
			if (v < 1e134)	return format(v / 1e129, "e129");
			if (v < 1e137)	return format(v / 1e132, "e132");
			if (v < 1e140)	return format(v / 1e135, "e135");
			if (v < 1e143)	return format(v / 1e138, "e138");
			if (v < 1e146)	return format(v / 1e141, "e141");
			if (v < 1e149)	return format(v / 1e144, "e144");
			if (v < 1e152)	return format(v / 1e147, "e147");
			if (v < 1e155)	return format(v / 1e150, "e150");
			if (v < 1e158)	return format(v / 1e153, "e153");
			if (v < 1e161)	return format(v / 1e156, "e156");
			if (v < 1e164)	return format(v / 1e159, "e159");
			if (v < 1e167)	return format(v / 1e162, "e162");
			if (v < 1e170)	return format(v / 1e165, "e165");
			if (v < 1e173)	return format(v / 1e168, "e168");
			if (v < 1e176)	return format(v / 1e171, "e171");
			if (v < 1e179)	return format(v / 1e174, "e174");
			if (v < 1e182)	return format(v / 1e177, "e177");
			if (v < 1e185)	return format(v / 1e180, "e180");
			if (v < 1e188)	return format(v / 1e183, "e183");
			if (v < 1e191)	return format(v / 1e186, "e186");
			if (v < 1e194)	return format(v / 1e189, "e189");
			if (v < 1e197)	return format(v / 1e192, "e192");
			if (v < 1e200)	return format(v / 1e195, "e195");
			if (v < 1e203)	return format(v / 1e198, "e198");
			if (v < 1e206)	return format(v / 1e201, "e201");
			if (v < 1e209)	return format(v / 1e204, "e204");
			if (v < 1e212)	return format(v / 1e207, "e207");
			if (v < 1e215)	return format(v / 1e210, "e210");
			if (v < 1e218)	return format(v / 1e213, "e213");
			if (v < 1e221)	return format(v / 1e216, "e216");
			if (v < 1e224)	return format(v / 1e219, "e219");
			if (v < 1e227)	return format(v / 1e222, "e222");
			if (v < 1e230)	return format(v / 1e225, "e225");
			if (v < 1e233)	return format(v / 1e228, "e228");
			if (v < 1e236)	return format(v / 1e231, "e231");
			if (v < 1e239)	return format(v / 1e234, "e234");
			if (v < 1e242)	return format(v / 1e237, "e237");
			if (v < 1e245)	return format(v / 1e240, "e240");
			if (v < 1e248)	return format(v / 1e243, "e243");
			if (v < 1e251)	return format(v / 1e246, "e246");
			if (v < 1e254)	return format(v / 1e249, "e249");
			if (v < 1e257)	return format(v / 1e252, "e252");
			if (v < 1e260)	return format(v / 1e255, "e255");
			if (v < 1e263)	return format(v / 1e258, "e258");
			if (v < 1e266)	return format(v / 1e261, "e261");
			if (v < 1e269)	return format(v / 1e264, "e264");
			if (v < 1e272)	return format(v / 1e267, "e267");
			if (v < 1e275)	return format(v / 1e270, "e270");
			if (v < 1e278)	return format(v / 1e273, "e273");
			if (v < 1e281)	return format(v / 1e276, "e276");
			if (v < 1e284)	return format(v / 1e279, "e279");
			if (v < 1e287)	return format(v / 1e282, "e282");
			if (v < 1e290)	return format(v / 1e285, "e285");
			if (v < 1e293)	return format(v / 1e288, "e288");
			if (v < 1e296)	return format(v / 1e291, "e291");
			if (v < 1e299)	return format(v / 1e294, "e294");
			if (v < 1e302)	return format(v / 1e297, "e297");
			if (v < 1e305)	return format(v / 1e300, "e300");
		 ...
		 * @return
		 */
		private static String format(double v, String danWei) {
			String a = v + "";
			a = removeDecimals(a);
			return a + danWei;
		}
	...
	public static class Actor {
		public static void setOriginToCenter(
				com.badlogic.gdx.scenes.scene2d.Actor a) {
			a.setOrigin(a.getWidth() / 2, a.getHeight() / 2);
		}

		public static com.badlogic.gdx.scenes.scene2d.Actor getParent(
				com.badlogic.gdx.scenes.scene2d.Actor a, Class<?> c) {
			Group current = a.getParent();
			while (true) {
				if (current == null) {
					return null;
				}
