...
public class QuitPopAd {
	...
	private final class OnClickListenerImpl2 implements
	...
	private final class OnClickListenerImpl implements
			AlertDialog.OnClickListener {
		private final Context context;

		private OnClickListenerImpl(Context context) {
	...
	public void show(final Context context){
		...
		if(AppConnect.getInstance(context).hasPopAd(context)){
			...
			if(view != null){
				...
				.setPositiveButton("确定", new OnClickListenerImpl(context))
				.setNegativeButton("取消", new OnClickListenerImpl2())
				.create().show();
