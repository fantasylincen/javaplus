...
public class BitmapFontMetricsTest extends GdxTest {
	...
	public void create() {
		...
		font = new BitmapFont(Gdx.files.internal("data/verdana39.fnt"),
				atlas.findRegion("verdana39"), false);
	...
	public void render() {
		...
		renderer.line(0, baseline + font.getXHeight(), 9999,
				baseline + font.getXHeight());
		renderer.setColor(Color.CYAN);
		renderer.line(0, y + font.getAscent(), 9999, y + font.getAscent());
		renderer.setColor(Color.RED);
		renderer.line(0, baseline + font.getDescent(), 9999,
				baseline + font.getDescent());
		renderer.setColor(Color.ORANGE);
		renderer.line(0, y - font.getLineHeight(), 9999,
