...
public class IntegerBitmapFontTest extends GdxTest {
	...
	public void create() {
		...
		font = new BitmapFont(Gdx.files.internal("data/verdana39.fnt"),
				textureAtlas.findRegion("verdana39"), false);
	...
	private void fillCaches() {
		...
		multiLineCache.setMultiLineText(text, 10.5f, 180.5f, 200,
				HAlignment.CENTER);
		...
		multiLineCacheNonInteger.setMultiLineText(text, 10.5f, 180.5f, 200,
				HAlignment.CENTER);
	}
