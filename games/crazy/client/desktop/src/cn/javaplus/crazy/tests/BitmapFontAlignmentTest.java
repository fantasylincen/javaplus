...
/**
 * Shows how to align single line, wrapped, and multi line text within a
 * rectangle.
 */
public class BitmapFontAlignmentTest extends GdxTest {
	...
	public void create() {
		...
		font = new BitmapFont(Gdx.files.getFileHandle("data/verdana39.fnt",
				FileType.Internal), Gdx.files.getFileHandle(
	...
	private void renderMultiLine() {
		...
		// font.drawMultiLine(spriteBatch, text, x, y, width,
		// HAlignment.CENTER);
	}
