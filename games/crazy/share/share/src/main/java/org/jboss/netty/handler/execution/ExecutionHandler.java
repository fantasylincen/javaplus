 ...
 * You can implement an alternative thread model such as <a
 * href="http://en.wikipedia.org/wiki/Staged_event-driven_architecture">SEDA</a>
 ...
 * I/O threads to control the incoming traffic and avoid
...
public class ExecutionHandler implements ChannelUpstreamHandler,
		ChannelDownstreamHandler, ExternalResourceReleasable {
	...
	public ExecutionHandler(Executor executor, boolean handleDownstream,
		...
		if (!handleDownstream && !handleUpstream) {
			throw new IllegalArgumentException(
					"You must handle at least handle one event type");
		}
	 ...
	 */
	protected boolean handleReadSuspend(ChannelHandlerContext ctx,
			ChannelEvent e) {
