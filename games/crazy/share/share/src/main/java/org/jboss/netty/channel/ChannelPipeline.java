 ...
 * >Intercepting Filter</a> pattern to give a user full control over how an
 * event is handled and how the {@link ChannelHandler}s in the pipeline interact
 * with each other.
 * 
 ...
 * therefore the actual evaluation order of a downstream event will be: 4 and 3.
 * </li>
...
public interface ChannelPipeline {
	 ...
	 *             {@code null}
	 */
	void replace(ChannelHandler oldHandler, String newName,
	 ...
	 *             {@code null}
	 */
	ChannelHandler replace(String oldName, String newName,
			ChannelHandler newHandler);
