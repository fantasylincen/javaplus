...
class NioClientSocketPipelineSink extends AbstractNioChannelSink {
	...
	static final InternalLogger logger = InternalLoggerFactory
			.getInstance(NioClientSocketPipelineSink.class);
	...
	public void eventSunk(ChannelPipeline pipeline, ChannelEvent e)
		...
		if (e instanceof ChannelStateEvent) {
			...
			NioClientSocketChannel channel = (NioClientSocketChannel) event
					.getChannel();
			...
			case CONNECTED:
				...
				break;
			case INTEREST_OPS:
				channel.worker.setInterestOps(channel, future,
	...
	private void connect(final NioClientSocketChannel channel,
			final ChannelFuture cf, SocketAddress remoteAddress) {
