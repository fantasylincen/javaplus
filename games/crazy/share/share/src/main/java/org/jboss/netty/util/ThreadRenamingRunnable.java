...
public class ThreadRenamingRunnable implements Runnable {
	...
	private static final InternalLogger logger = InternalLoggerFactory
			.getInstance(ThreadRenamingRunnable.class);
	 ...
	 * full thread dump.
	 */
	public static void setThreadNameDeterminer(
	...
	public void run() {
		...
		if (!oldThreadName.equals(newThreadName)) {
			try {
				...
				logger.debug("Failed to rename a thread "
	...
	private String getNewThreadName(String currentThreadName) {
		...
		try {
			...
			newThreadName = nameDeterminer.determineThreadName(
