 ...
 * by different threads. For example, the Event A2 is executed by the thread Y
 ...
 * use a weak key map such as <a
 * href="http://goo.gl/TqGl1">ConcurrentWeakHashMap</a> or synchronized
 * {@link WeakHashMap} instead of managing the life cycle of the keys by
 * yourself.
 * 
 * @apiviz.landmark
 */
