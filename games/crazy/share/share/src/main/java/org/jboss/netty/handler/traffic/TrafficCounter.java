...
public class TrafficCounter {
	...
	private static class TrafficMonitoringTask implements TimerTask {
		...
		public void run(Timeout timeout) throws Exception {
			...
			counter.timer.newTimeout(this, counter.checkInterval.get(),
	...
	public void start() {
		synchronized (lastTime) {
			...
			if (checkInterval.get() > 0) {
				...
				timerTask = new TrafficMonitoringTask(trafficShapingHandler,
						this);
				timeout = timer.newTimeout(timerTask, checkInterval.get(),
						TimeUnit.MILLISECONDS);
			}
		}
	}
