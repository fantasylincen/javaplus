 ...
 * SelectionKey}. It is represented as a <a
 * href="http://en.wikipedia.org/wiki/Bit_field">bit field</a> which is composed
 * of the two flags.
 * <ul>
 ...
 * pending writes that lead to an {@link OutOfMemoryError}. For example, the NIO
