...
final class SocksCommonUtils {
	...
	public static String intToIp(int i) {
		return String.valueOf(i >> FIRST_ADDRESS_OCTET_SHIFT
				& XOR_DEFAULT_VALUE)
				+ '.'
	...
	/*
	 * Convert numeric IPv6 to compressed format, where the longest sequence of
	 * 0's (with 2 or more 0's) is replaced with "::"
	 */
	...
	private static void ipv6toStr(StringBuilder sb, byte[] src, int fromHextet,
			int toHextet) {
