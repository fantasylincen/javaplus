...
final class PemReader {
	...
	static ChannelBuffer[] readCertificates(File file)
		...
		for (;;) {
			...
			certs.add(Base64.decode(ChannelBuffers.copiedBuffer(m.group(1),
	...
	static ChannelBuffer readPrivateKey(File file) throws KeyException {
		...
		return Base64.decode(ChannelBuffers.copiedBuffer(m.group(1),
				CharsetUtil.US_ASCII));
	}
