 ...
 * href="http://en.wikipedia.org/wiki/Zero-copy">zero-copy file transfer</a>.
 * 
 ...
 * <ul>
 * <li><a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=5103988">5103988</a>
 * - FileChannel.transferTo() should return -1 for EAGAIN instead throws
 * IOException</li>
 * <li><a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6253145">6253145</a>
 * - FileChannel.transferTo() on Linux fails when going beyond 2GB boundary</li>
 * <li><a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6427312">6427312</a>
 * - FileChannel.transferTo() throws IOException "system call interrupted"</li>
 * <li><a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6524172">6470086</a>
