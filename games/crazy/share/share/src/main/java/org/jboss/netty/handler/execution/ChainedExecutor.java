...
/**
 * A special {@link Executor} which allows to chain a series of {@link Executor}
 * s and {@link ChannelEventRunnableFilter}.
 */
public class ChainedExecutor implements Executor, ExternalResourceReleasable {
	 ...
	 */
	public ChainedExecutor(ChannelEventRunnableFilter filter, Executor cur,
			Executor next) {
		if (filter == null) {
