...
/**
 * TODO Make EmbeddedChannel implement ChannelConfig and ChannelSink to reduce
 * overhead. TODO Do not extend AbstractChannel to reduce overhead and remove
 * the internal-use-only constructor in AbstractChannel.
 */
