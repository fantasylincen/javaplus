...
public class NioWorker extends AbstractNioWorker {
	...
	protected boolean read(SelectionKey k) {
		...
		final ReceiveBufferSizePredictor predictor = channel.getConfig()
				.getReceiveBufferSizePredictor();
		final int predictedRecvBufSize = predictor.nextReceiveBufferSize();
		final ChannelBufferFactory bufferFactory = channel.getConfig()
				.getBufferFactory();
		...
		ByteBuffer bb = recvBufferPool.get(predictedRecvBufSize).order(
	...
	@Override
	protected boolean scheduleWriteIfNecessary(
			final AbstractNioChannel<?> channel) {
	...
	private final class RegisterTask implements Runnable {
		...
		RegisterTask(NioSocketChannel channel, ChannelFuture future,
				boolean server) {
		...
		public void run() {
			...
			try {
				...
				channel.channel.register(selector, channel.getRawInterestOps(),
						channel);
