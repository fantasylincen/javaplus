...
public enum Base64Dialect {
	 ...
	 */
	STANDARD(new byte[] { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D',
	 ...
	 * href="http://www.faqs.org/rfcs/rfc3548.html">RFC3548</a>. It is important
	 * to note that data encoded this way is <em>not</em> officially valid
	 * Base64, or at the very least should not be called Base64 without also
	 * specifying that is was encoded using the URL-safe dialect.
	 */
	URL_SAFE(new byte[] { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D',
			(byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I',
			(byte) 'J', (byte) 'K', (byte) 'L', (byte) 'M', (byte) 'N',
			(byte) 'O', (byte) 'P', (byte) 'Q', (byte) 'R', (byte) 'S',
			(byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X',
	 ...
	 */
	ORDERED(new byte[] { (byte) '-', (byte) '0', (byte) '1', (byte) '2',
			...
			(byte) 'N', (byte) 'O', (byte) 'P', (byte) 'Q', (byte) 'R',
			(byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W',
			(byte) 'X', (byte) 'Y', (byte) 'Z', (byte) '_', (byte) 'a',
