...
final class LocalServerChannelSink extends AbstractChannelSink {
	...
	private static void handleServerChannel(ChannelEvent e) {
		...
		DefaultLocalServerChannel channel = (DefaultLocalServerChannel) event
				.getChannel();
	...
	private static void bind(DefaultLocalServerChannel channel,
			ChannelFuture future, LocalAddress localAddress) {
		try {
	...
	private static void close(DefaultLocalServerChannel channel,
