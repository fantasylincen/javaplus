 ...
 */
abstract class AbstractOioWorker<C extends AbstractOioChannel> implements
		Worker {
	...
	static void setInterestOps(AbstractOioChannel channel,
	...
	private static void close(AbstractOioChannel channel, ChannelFuture future,
			boolean iothread) {
