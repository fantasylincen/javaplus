 ...
 * <p>
 * The following example implements the consolidation strategy that reduces the
 ...
 * example, you could call {@link #flush()} periodically, using
 * {@link HashedWheelTimer} every second.
 * 
 * @apiviz.landmark
 */
public class BufferedWriteHandler extends SimpleChannelHandler implements
	...
	private List<MessageEvent> consolidatedWrite(
			final List<MessageEvent> pendingWrites) {
