...
public class DefaultDatagramChannelConfig extends DefaultChannelConfig
	...
	private static final ReceiveBufferSizePredictorFactory DEFAULT_PREDICTOR_FACTORY = new FixedReceiveBufferSizePredictorFactory(
			768);
	...
	public ReceiveBufferSizePredictor getReceiveBufferSizePredictor() {
		...
		if (predictor == null) {
			try {
				this.predictor = predictor = getReceiveBufferSizePredictorFactory()
						.getPredictor();
			} catch (Exception e) {
				throw new ChannelException("Failed to create a new "
	...
	public void setReceiveBufferSizePredictorFactory(
