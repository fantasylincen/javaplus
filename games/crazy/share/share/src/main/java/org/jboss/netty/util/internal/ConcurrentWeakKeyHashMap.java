 ...
 */
public final class ConcurrentWeakKeyHashMap<K, V> extends AbstractMap<K, V>
	...
	final class KeyIterator extends HashIterator implements
			ReusableIterator<K>, Enumeration<K> {
	...
	final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
		...
		public boolean remove(Object o) {
			...
			Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
			return ConcurrentWeakKeyHashMap.this.remove(e.getKey(),
					e.getValue());
		}
