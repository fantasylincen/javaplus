 ...
 * @apiviz.landmark
 */
public class NioClientSocketChannelFactory implements
	 ...
	 */
	public NioClientSocketChannelFactory(Executor bossExecutor,
			Executor workerExecutor, int workerCount) {
	 ...
	 */
	public NioClientSocketChannelFactory(Executor bossExecutor,
			Executor workerExecutor, int bossCount, int workerCount) {
		this(bossExecutor, bossCount, new NioWorkerPool(workerExecutor,
				workerCount));
	}
	 ...
	 */
	public NioClientSocketChannelFactory(Executor bossExecutor, int bossCount,
	...
	public NioClientSocketChannelFactory(Executor bossExecutor, int bossCount,
		...
		this(new NioClientBossPool(bossExecutor, bossCount, timer, null),
				workerPool);
	}
	 ...
	 *            the {@link WorkerPool} to use to do the IO
	 */
	public NioClientSocketChannelFactory(BossPool<NioClientBoss> bossPool,
			WorkerPool<NioWorker> workerPool) {
	...
	private void releasePools() {
		...
		if (workerPool instanceof ExternalResourceReleasable) {
			((ExternalResourceReleasable) workerPool)
