...
public class PixmapPackerTest extends GdxTest {
	...
	public void create() {
		...
		PixmapPacker packer = new PixmapPacker(1024, 1024, Format.RGBA8888, 2,
				true);
		...
		atlas = packer.generateTextureAtlas(TextureFilter.Nearest,
				TextureFilter.Nearest, false);
		Gdx.app.log("PixmaPackerTest",
				"Number of textures: " + atlas.getTextures().size);
	}
