...
public class LabelTest extends GdxTest {
	...
	public void create() {
		...
		skin.getAtlas().getTextures().iterator().next()
		...
		Label label4 = new Label(
				"This is regular text with NO newlines, wrap enabled and aligned bottom, right.",
				skin);
		label4.setWrap(true);
	...
	public void render() {
		...
		drawLine(x, y - font.getCapHeight() + font.getDescent(), x + 1000, y
				- font.getCapHeight() + font.getDescent());
	}
