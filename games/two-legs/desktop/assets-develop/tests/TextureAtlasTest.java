...
public class TextureAtlasTest extends GdxTest {
	...
	public void create() {
		...
		jumpAnimation = new Animation(0.25f,
				jumpAtlas.findRegions("ALIEN_JUMP_"));
		...
		System.out.println("badlogicSmall original size: "
				+ region.originalWidth + ", " + region.originalHeight);
		System.out.println("badlogicSmall packed size: " + region.packedWidth
				+ ", " + region.packedHeight);
