...
public class EarClippingTriangulatorTest {
	...
	//
	// // Starfleet insigna
	// testCases.add(new TestCase(new float[] {0, 0, 0.6f, 0.4f, 1, 0, 0.5f,
	// 1,}));
	//
	// // Starfleet insigna with repeated point
	// testCases.add(new TestCase(new float[] {0, 0, 0.6f, 0.4f, 0.6f, 0.4f, 1,
	// 0, 0.5f, 1,}));
	//
	...
	// testCases.add(new TestCase(new float[] {0, 0, 1, 1, 2, 0, 3, 1, 4, 0,},
	// true));
	//
	// // Plus shape
	// testCases.add(new TestCase(new float[] {1, 0, 2, 0, 2, 1, 3, 1, 3, 2, 2,
	// 2, 2, 3, 1, 3, 1, 2, 0, 2, 0, 1, 1, 1,}));
	//
	// // Star shape
	// testCases.add(new TestCase(new float[] {4, 0, 5, 3, 8, 4, 5, 5, 4, 8, 3,
	// 5, 0, 4, 3, 3,}));
	//
	// // U shape
	// testCases.add(new TestCase(new float[] {1, 0, 2, 0, 3, 1, 3, 3, 2, 3, 2,
	// 1, 1, 1, 1, 3, 0, 3, 0, 1,}));
	//
	// // Spiral
	// testCases.add(new TestCase(new float[] {1, 0, 4, 0, 5, 1, 5, 4, 4, 5, 1,
	// 5, 0, 4, 0, 3, 1, 2, 2, 2, 3, 3, 1, 3, 1, 4, 4, 4,
	// 4, 1, 0, 1,}));
	//
	// // Test case from
	// http://www.flipcode.com/archives/Efficient_Polygon_Triangulation.shtml
	// testCases.add(new TestCase(new float[] {0, 6, 0, 0, 3, 0, 4, 1, 6, 1, 8,
	// 0, 12, 0, 13, 2, 8, 2, 8, 4, 11, 4, 11, 6, 6, 6,
	// 4, 3, 2, 6,}));
	//
	// // Self-intersection
	// testCases.add(new TestCase(new float[] {0, 0, 1, 1, 2, -1, 3, 1, 4, 0,},
	// true));
	//
	// // Self-touching
	// testCases.add(new TestCase(new float[] {0, 0, 4, 0, 4, 4, 2, 4, 2, 3, 3,
	// 3, 3, 1, 1, 1, 1, 3, 2, 3, 2, 4, 0, 4,}, true));
	//
	// // Self-overlapping
	// testCases.add(new TestCase(new float[] {0, 0, 4, 0, 4, 4, 1, 4, 1, 3, 3,
	// 3, 3, 1, 1, 1, 1, 3, 3, 3, 3, 4, 0, 4,}, true));
	//
	// // Test case from http://www.davdata.nl/math/polygons.html
	// testCases.add(new TestCase(new float[] {190, 480, 140, 180, 310, 100,
	// 330, 390, 290, 390, 280, 260, 220, 260, 220, 430,
	// 370, 430, 350, 30, 50, 30, 160, 560, 730, 510, 710, 20, 410, 30, 470,
	// 440, 640, 410, 630, 140, 590, 140, 580, 360, 510,
	// 370, 510, 60, 650, 70, 660, 450, 190, 480,}));
	//
	// // Issue 815, http://code.google.com/p/libgdx/issues/detail?id=815
	// testCases.add(new TestCase(new float[] {-2.0f, 0.0f, -2.0f, 0.5f, 0.0f,
	// 1.0f, 0.5f, 2.875f, 1.0f, 0.5f, 1.5f, 1.0f, 2.0f,
	// 1.0f, 2.0f, 0.0f,}));
	//
	// // Issue 207, comment #1,
	// http://code.google.com/p/libgdx/issues/detail?id=207#c1
	// testCases.add(new TestCase(new float[] {72.42465f, 197.07095f,
	// 78.485535f, 189.92776f, 86.12059f, 180.92929f, 99.68253f,
	// 164.94557f, 105.24325f, 165.79604f, 107.21862f, 166.09814f, 112.41958f,
	// 162.78253f, 113.73238f, 161.94562f, 123.29477f,
	// 167.93805f, 126.70667f, 170.07617f, 73.22717f, 199.51062f,}));
	//
	// // Issue 207, comment #11,
	// http://code.google.com/p/libgdx/issues/detail?id=207#c11
	// // Also on issue 1081,
	// http://code.google.com/p/libgdx/issues/detail?id=1081
	// testCases.add(new TestCase(new float[] {2400.0f, 480.0f, 2400.0f, 176.0f,
	// 1920.0f, 480.0f, 1920.0459f, 484.22314f,
	// 1920.1797f, 487.91016f, 1920.3955f, 491.0874f, 1920.6875f, 493.78125f,
	// 1921.0498f, 496.01807f, 1921.4766f, 497.82422f,
	// 1921.9619f, 499.22607f, 1922.5f, 500.25f, 1923.085f, 500.92236f,
	// 1923.7109f, 501.26953f, 1924.3721f, 501.31787f,
	// 1925.0625f, 501.09375f, 1925.7764f, 500.62354f, 1926.5078f, 499.9336f,
	// 1927.251f, 499.0503f, 1928.0f, 498.0f, 1928.749f,
	// 496.80908f, 1929.4922f, 495.5039f, 1930.2236f, 494.11084f, 1930.9375f,
	// 492.65625f, 1931.6279f, 491.1665f, 1932.2891f,
	// 489.66797f, 1932.915f, 488.187f, 1933.5f, 486.75f, 1934.0381f, 485.3833f,
	// 1934.5234f, 484.11328f, 1934.9502f, 482.9663f,
	...
	// testCases.add(new TestCase(new float[] {3.914329f, 1.9008259f, 4.414321f,
	// 1.903619f, 4.8973203f, 1.9063174f, 5.4979978f,
	// 1.9096732f,}, true));
	//
	// // Issue 1407, http://code.google.com/p/libgdx/issues/detail?id=1407,
	...
	// }
	// boundingRect = new Rectangle(min.x, min.y, Math.max(0.001f, max.x -
	// min.x), Math.max(0.001f, max.y - min.y));
	//
	...
	// VertexAttributes positionAndColor = new VertexAttributes(new
	// VertexAttribute(Usage.Position, 2,
	...
	// ShortArray triangles = new
	// EarClippingTriangulator().computeTriangles(polygon);
	//
	...
	// interiorMesh.setVertices(listToColoredVertexArray(polygon, triangles,
	// getColor()));
	// triangleOutlineMesh.setVertices(triangleOutlines.items, 0,
	// triangleOutlines.size);
	// }
	//
	...
	// for (int i = 0, lastIndex = polygon.size - 2, n = polygon.size / 2; i <
	// n; i++) {
	// int ii = lastIndex - i;
	...
	// }
	//
	// static float[] listToColoredVertexArray (FloatArray vertices, ShortArray
