...
public class ActionTest extends GdxTest implements Runnable {
	...
	public void create() {
		...
		// // });
		// //
		// // Action actionDelay = Delay.$(actionMoveBy,
		// 1).setCompletionListener(
		// // new OnActionCompleted() {
		// //
		// // @Override
		// // public void completed(Action action) {
		...
		//
		// // img.action(Repeat.$(Sequence.$(MoveBy.$(50, 0, 1), MoveBy.$(0, 50,
		// 1), MoveBy.$(-50, 0, 1), MoveBy.$(0, -50, 1)), 3));
		...
		// // Sequence.$(ScaleTo.$(0.1f, 0.1f, 1.5f), ScaleTo.$(1.0f, 1.0f,
		// 1.5f))).setCompletionListener(this));
		// // }
		// // };
		// //
		// // img.action(Parallel.$(Sequence.$(FadeOut.$(2), FadeIn.$(2)),
		// // Sequence.$(ScaleTo.$(0.1f, 0.1f, 1.5f), ScaleTo.$(1.0f, 1.0f,
		// 1.5f))).setCompletionListener(listener));
		//
		// // img.action(
		// // Sequence.$(
		// // Parallel.$(RotateBy.$(180, 2), ScaleTo.$(1.4f, 1.4f, 2),
		// FadeTo.$(0.7f, 2)),
		// // Parallel.$(RotateBy.$(180, 2), ScaleTo.$(1.0f, 1.0f, 2),
		// FadeTo.$(1.0f, 2)),
		// // Remove.$()
		// // )
		// // );
		...
		// // ScaleTo scaleCountdown = ScaleTo.$(scale * 1.0f, scale * 1.0f,
		// 1.0f);
		...
		// // Sequence cdAnim = Sequence.$(Delay.$(parallel, showDuration),
		// Remove.$());
		// // cdAnim.setCompletionListener(this);
		// // img.action(cdAnim);
		// //
		// // Delay delay = Delay.$(MoveBy.$(100, 100,
		// 1).setCompletionListener(this), 1);
