...
public class PolygonSpriteTest extends GdxTest {
	...
	public void create() {
		...
		for (int i = 0; i < 50; i++) {
			...
			sprite.setPosition(MathUtils.random(-30, 440),
					MathUtils.random(-30, 290));
			sprite.setColor(MathUtils.random(), MathUtils.random(),
	...
	public void render() {
		...
		renderer.circle(sprite.getX() + sprite.getOriginX(), sprite.getY()
				+ sprite.getOriginY(), 4);
