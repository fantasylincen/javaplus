...
public abstract class BaseG3dHudTest extends BaseG3dTest {
	...
	protected String models[] = new String[] { "car.obj", "cube.obj",
			...
			"g3d/head.g3db", "g3d/knight.g3dj", "g3d/knight.g3db",
			"g3d/monkey.g3db", "g3d/ship.obj", "g3d/shapes/cube_1.0x1.0.g3dj",
	...
	protected CollapsableWindow addListWindow(String title, List list, float x,
			float y) {
