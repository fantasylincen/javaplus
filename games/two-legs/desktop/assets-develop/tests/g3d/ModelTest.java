...
public class ModelTest extends BaseG3dHudTest {
	...
	public void create() {
		...
		environment.set(new ColorAttribute(ColorAttribute.AmbientLight, 0.4f,
				0.4f, 0.4f, 1.f));
		environment.add(new DirectionalLight().set(0.8f, 0.8f, 0.8f, -0.5f,
				-1.0f, -0.8f));
	...
	protected void onLoaded() {
		...
		if (instance.animations.size > 0)
			animationControllers.put(instance,
					new AnimationController(instance));
	...
	protected void switchAnimation() {
		for (ObjectMap.Entry<ModelInstance, AnimationController> e : animationControllers
			...
			e.value.animate((animIndex == e.key.animations.size) ? null
					: e.key.animations.get(animIndex).id, -1, 1f, null, 0.2f);
		}
	}
