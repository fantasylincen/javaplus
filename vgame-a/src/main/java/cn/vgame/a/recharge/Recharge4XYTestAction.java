 ...
 * 
 */
public class Recharge4XYTestAction extends ActionSupport {
	...
	public String callBack(String orderid, String uid, String serverid,
		...
		try {
			...
			role.addRechargeHistory(a.getCoin(), "xy test");
			...
			Log.d("recharge xy test success", role.getId(), role.getNick(),
